...
//            String[] coordinates = {"52,30", "134,33", "102,89"};
            ...
            Thread.sleep(2000);
            WebElement showInfoElement = driver.findElement(By.id("A_0"));
            showInfoElement.click();
            ...
            WebElement infoElement = driver.findElement(By.className("info-table-list"));
            // 截取该元素的屏幕截图
            File screenshotFile = infoElement.getScreenshotAs(OutputType.FILE);
            // 保存截图到指定文件路径
            FileUtil.copyFile(screenshotFile, new File("screenshot.png"));
        } catch (Exception e) {
