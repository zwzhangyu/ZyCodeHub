package com.zy.bytecode;

import com.zy.bytecode.handler.ClassFileAnalysiser;
...
public class ClassFileAnalysisMain {
    ...
    public static void main(String[] args) throws Exception {
        // 读取class文件
        ByteBuffer codeBuf = readFile("E:\\ZhangYuCodeHub\\java-agent\\bytecode\\target\\classes\\com\\zy\\bytecode\\test\\HelloWorld.class");
        // 解析class文件
